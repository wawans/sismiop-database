 ...
 * @property string|null $thn_peng_pst
 * @property string|null $jns_sk
 * @property string|null $no_sk
 * @property string|null $status_sk_peng_pst
 * @property string|null $pct_pengurangan_pst
 * @property string|null $sys_nc00018$
 *
 * @method static \Illuminate\Database\Eloquent\Builder<static>|PenguranganPst newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|PenguranganPst newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|PenguranganPst query()
 *
 * @mixin \Eloquent
 */
class PenguranganPst extends Model
{
    /**
