 ...
 * @property string $nip_pengirim_berkas
 *
 * @method static \Illuminate\Database\Eloquent\Builder<static>|BerkasKirim newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|BerkasKirim newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|BerkasKirim query()
 *
 * @mixin \Eloquent
 */
class BerkasKirim extends Model
{
    /**
