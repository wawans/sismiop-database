 ...
 * @property string $no_urut_posisi_berkas
 ...
 * @property bool $akhir_posisi_berkas
 * @property \Illuminate\Support\Carbon $tgl_posisi_berkas
 ...
 * @property-read RefSeksi|null $refSeksi
 * @property-read LookupItem|null $refStatusBerkas
 * @property-read RefSubSeksi|null $refSubSeksi
 *
 * @method static \Illuminate\Database\Eloquent\Builder<static>|PstPosisiBerkas kirim()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|PstPosisiBerkas newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|PstPosisiBerkas newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|PstPosisiBerkas posisiBerkasTerakhir()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|PstPosisiBerkas query()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|PstPosisiBerkas terima()
 *
 * @mixin \Eloquent
 */
