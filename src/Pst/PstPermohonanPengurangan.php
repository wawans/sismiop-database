 ...
 * @property int|null $pct_permohonan_pengurangan
 * @property-read \Wawans\SismiopDatabase\Pst\PstPermohonan $pstPermohonan
 * @property-read LookupItem|null $refJnsPengurangan
 *
 * @method static \Illuminate\Database\Eloquent\Builder<static>|PstPermohonanPengurangan newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|PstPermohonanPengurangan newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|PstPermohonanPengurangan query()
 *
 * @mixin \Eloquent
 */
