...
/**
 * Wawans\SismiopDatabase\Dat\DatJpb8
 *
 ...
 * @property string|null $ting_kolom_jpb8
 * @property string|null $lbr_bent_jpb8
 * @property string|null $luas_mezzanine_jpb8
 * @property string|null $keliling_dinding_jpb8
 * @property string|null $daya_dukung_lantai_jpb8
 ...
 *
 * @method static \Illuminate\Database\Eloquent\Builder<static>|DatJpb8 newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|DatJpb8 newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|DatJpb8 query()
 *
 * @mixin \Eloquent
 */
class DatJpb8 extends Model
{
